...
-- $HOME/.local/source/java_lsp_extensions/vscode-java-test/server/
...
local config = {
  ...
  on_attach = function(client, bufnr)
    ...
    vim.keymap.set("n", "<leader>df", require 'jdtls'.dap.test_class,
  ...
  settings = {
    java = {
      ...
      format = {
        ...
        -- TODO: Rename
        settings = {
          url = vim.fn.expand("$HOME/.config/nvim/lua/lsp/GoogleInspired.xml"),
          profile = "Default",
        },
      },
    },
